      ...
      <Container className="py-1">
        ...
        <Navbar.Collapse id="navbarScroll">
          ...
          >
            ...
            <Nav.Link href="/year" className="text-white">
              movie 2022
            </Nav.Link>
            <Nav.Link href="/trailers" className="text-white">
              movie trailers
            </Nav.Link>
            <Nav.Link href="/" className="text-white">
              About us
          ...
          <div className="d-flex navbar-search">
            ...
            >
              <NavDropdown.Item>
                <Link to="/year" className="me-4 ">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                    fill="currentColor"
                    className="bi bi-twitter icon-dark"
                    viewBox="0 0 16 16"
                  >
                    <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z" />
                  </svg>
                </Link>
                <Link to="/trailers" className="me-4">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                    fill="currentColor"
                    className="bi bi-facebook icon-dark"
                    viewBox="0 0 16 16"
                  >
                ...
                <Link to="/" className="me-4">
                  <svg
                    ...
                    height="16"
                    fill="currentColor"
                    className="bi bi-instagram icon-dark"
                    viewBox="0 0 16 16"
                  >
                ...
                <Link to="/" className="me-4">
                  <svg
                    ...
                    height="16"
                    fill="currentColor"
                    className="bi bi-youtube icon-dark"
                    viewBox="0 0 16 16"
                  >
            ...
            <Modal
              ...
              backdropClassName="modal-search-backdrop"
            >
              <Modal.Header closeButton />
              <Modal.Title
                id="example-custom-modal-styling-title"
                className="title-search-modal"
              >
                <form className=" py-3  d-flex  input-search-modal">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
                    fill="blue"
                    className="bi bi-search ms-3 "
                    viewBox="0 0 16 16"
                  >
                    <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
                  </svg>
                  ...
                  <input
                    type={"text"}
                    onChange={getsearchletters}
                    className="mb-5  border-no-border"
                    placeholder="search movieDB data base"
                  ></input>
                </form>
              </Modal.Title>
